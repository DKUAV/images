...
Lightweight CUDA/PyTorch runtime container with ROS 2 Jazzy and CMake. No interactive dev tools, devshell, or C++ toolchain extensions. Intended for deployment and CI pipelines on amd64 workstations and arm64 (Jetson) boards with NVIDIA GPU support.
